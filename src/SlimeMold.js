...
import { createSporeTextureProgram, createUpdateProgram, createRenderProgram, bindUpdateBuffer, bindPositionBuffer, bindSporeTextureBuffer, tagObject } from "./shaderUtils.js";
...
class SlimeMold {
  ...
  start = async () => {
    ...
    gl.bufferData(gl.ARRAY_BUFFER, new Float32Array([
      ...
      0, 1,
      1, 1,
    ]), gl.STATIC_DRAW) // Two triangles covering the entire texture
